...
public class IntentActionConstant {
    ...
    public static final String TASK_DETAIL_ACTION_FTP = "boss.action.task.detail.ftp";
    public static final String TASK_DETAIL_ACTION_MAGNET = "boss.action.task.detail.magnet";
    public static final String TASK_DETAIL_ACTION_VARIOUS = "boss.action.task.detail.various";
}
