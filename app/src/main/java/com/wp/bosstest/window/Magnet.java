package com.wp.bosstest.window;
...
public class Magnet implements View.OnTouchListener {
    ...
    protected int mInitialX = -1;
    protected int mInitialY = -1;
    ...
    protected Magnet(Context context, boolean isAddRemoveView) {
        this(context);
        if (isAddRemoveView) {
    ...
    // WindowManager.LayoutParams.TYPE_SYSTEM_ALERT //我就草了，不用TYPE_TOAST,android4.4不行
    ...
    public boolean onTouch(View view, MotionEvent event) {
        ...
        if (eaten) {
            ...
            if (action == MotionEvent.ACTION_DOWN) {
                Log.d(TAG, "touch, action == ACTION_DOWN");
                showRemoveView();
